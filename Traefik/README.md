...
## Configuration
Avant d'exécuter le container il faut créer un fichier de configuration avec le contenu du fichier traefik.yaml de ce repository.
```
nano /Traefik/traefik.yaml
```
