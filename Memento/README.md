...
- le répertoire "Nginx/www" sous ./Nginx/www
- le fichier "index.html" sous ./Nginx/www/index.html
- le répertoire "Icon" sous ./Nginx/www/Icon
- le fichier "IconBrown.png" sous ./Nginix/www/Icon/IconBrown.png
- le répertoire "Sites-enabled" sous ./Nginx/Sites-enabled
...
- le répertoire "Log" sous ./Nginx/Log
